...
const donationMethods: DonationMethod[] = [
	...
	{
		label: "PayPal",
		href: "https://www.paypal.me/samuelscheit?locale.x=de_DE",
	},
];

function DonateButton(props: AnchorHTMLAttributes<any>) {
	return (
		<a
			{...props}
			target="_blank"
					...
					>
						...
						<div className="space-y-4">
							...
							<p>
								...
								<span className="bold">without zoom limits</span>.
							</p>
							...
							<div>
								If you like the archive and would like to help to keep it online, please consider donating. It would help me a lot to cover the costs. Thank you very much :)
							</div>
				...
				>
					...
					>
						...
						<div className="flex flex-row gap-2 text-white flex-wrap items-stretch">
							<DonateButton href="https://www.patreon.com/samuelscheit" style={{ backgroundColor: "#F96854" }}>
							...
							<DonateButton href="https://github.com/sponsors/samuelscheit" style={{ backgroundColor: "#000" }}>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-4">
									<path
										fill="currentColor"
							...
							<DonateButton href="https://www.paypal.me/samuelscheit" style={{ backgroundColor: "#0070e0" }}>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-4">
									<path
										fill="currentColor"
							...
							<DonateButton href="https://buymeacoffee.com/samuelscheit" style={{ backgroundColor: "#52a447" }}>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="size-4">
									<path
										fill="white"
							...
							<DonateButton href="https://qr.alipay.com/fkx175153zjoblrjcwh4ode" style={{ backgroundColor: "#0e9dec" }}>
